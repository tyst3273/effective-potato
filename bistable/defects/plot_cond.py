...
y_list = [0.010,0.050,0.100,0.250,0.500]
...
for ii, y in enumerate(y_list):
    ...
    n, x, v, y, z = get_data(f'results_v_y_{y:.3f}_z_{z:.3f}.h5')
    ...
    g = n/x
    ax.plot(x[:,0],g[:,0],c='r',lw=0,marker='o',ms=0.5)
    ax.plot(x[:,1],g[:,1],c='g',lw=0,marker='o',ms=0.5)
    ax.plot(x[:,2],g[:,2],c='b',lw=0,marker='o',ms=0.5)
