...
ax[0,0].plot(v,n_lo,c='b',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[0,0].plot(v,n_hi,c='b',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[0,1].plot(v,x_lo,c='r',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[0,1].plot(v,x_hi,c='r',lw=1,ls=(0,(2,1)),marker='o',ms=1)
...
ax[1,0].plot(v,n_lo,c='b',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[1,0].plot(v,n_hi,c='b',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[1,1].plot(v,x_lo,c='r',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[1,1].plot(v,x_hi,c='r',lw=1,ls=(0,(2,1)),marker='o',ms=1)
...
ax[2,0].plot(v,n_lo,c='b',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[2,0].plot(v,n_hi,c='b',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[2,1].plot(v,x_lo,c='r',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[2,1].plot(v,x_hi,c='r',lw=1,ls=(0,(2,1)),marker='o',ms=1)
