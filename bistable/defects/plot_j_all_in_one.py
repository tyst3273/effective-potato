...
for y in y_list:
    ...
    ax[0].plot(j,n_lo,c='b',lw=1,ls=(0,(2,1)),marker='o',ms=1)
    ax[1].plot(j,x_lo,c='r',lw=1,ls=(0,(2,1)),marker='o',ms=1)
    ax[0].plot(j,n_hi,c='b',lw=1,ls=(0,(2,1)),marker='o',ms=1)
    ax[1].plot(j,x_hi,c='r',lw=1,ls=(0,(2,1)),marker='o',ms=1)
