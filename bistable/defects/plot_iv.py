...
try:
    ...
    _hi = 0
ax[0].plot([v[_lo],v[_lo]],[j[_lo,0],j[_lo,2]],c='m',lw=0,marker='o',ms=1)
ax[0].plot([v[_hi],v[_hi]],[j[_hi,0],j[_hi,2]],c='m',lw=0,marker='o',ms=1)
...
try:
    ...
    _hi = 0
ax[1].plot([v[_lo],v[_lo]],[j[_lo,0],j[_lo,2]],c='m',lw=0,marker='o',ms=1)
ax[1].plot([v[_hi],v[_hi]],[j[_hi,0],j[_hi,2]],c='m',lw=0,marker='o',ms=1)
