...
for ii, zz in enumerate(z_list):
    ...
    n, x, v, j, y, z = get_data(f'results_v_y_0.050_z_{zz:.3f}.h5')

    ax[0,0].plot(j,n,c=c,lw=0,marker='o',ms=1)
    ax[0,1].plot(j,x,c=c,lw=0,marker='o',ms=1)

    n, x, v, j, y, z = get_data(f'results_v_y_0.100_z_{zz:.3f}.h5')

    ax[1,0].plot(j,n,c=c,lw=0,marker='o',ms=1)
    ax[1,1].plot(j,x,c=c,lw=0,marker='o',ms=1)

    n, x, v, j, y, z = get_data(f'results_v_y_0.250_z_{zz:.3f}.h5')

    ax[2,0].plot(j,n,c=c,lw=0,marker='o',ms=1)
    ax[2,1].plot(j,x,c=c,lw=0,marker='o',ms=1)
