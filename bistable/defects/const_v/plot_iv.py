...
ax[0].plot(v,n_lo/x_lo,c='m',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[0].plot(v,n_hi/x_hi,c='m',lw=1,ls=(0,(2,1)),marker='o',ms=1)
...
ax[1].plot(v,n_lo/x_lo,c='m',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[1].plot(v,n_hi/x_hi,c='m',lw=1,ls=(0,(2,1)),marker='o',ms=1)
...
ax[2].plot(v,n_lo/x_lo,c='m',lw=1,ls=(0,(2,1)),marker='o',ms=1)
ax[2].plot(v,n_hi/x_hi,c='m',lw=1,ls=(0,(2,1)),marker='o',ms=1)
