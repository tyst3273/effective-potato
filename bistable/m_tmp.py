...
class c_bistable:
    ...
    def __init__(self,beta=4,gamma=1,alpha=1):
    ...
    def _evaluate_func(self,x,y,z):
        ...
        return np.exp(1 / x ** _g) * (x**_b + x**_a - y**_b - y**_a) - z**2
    ...
    def get_bistability_region(self,nx=5000,ny=5000,nz=1000,
...
if __name__ == '__main__':
    ...
    bistable = c_bistable()
    bistable.get_bistability_region(nx=1000,ny=1000,nz=1000,xlo=0,xhi=2,ylo=0,yhi=0.5,zlo=0,zhi=8)
