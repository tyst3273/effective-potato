...
#magneli.build_supercell([1,2,2])

#write_xyz('magneli.xyz',magneli)
#write_poscar('POSCAR_reduced',magneli)
#write_poscar('POSCAR_cart',magneli,cartesian=True)
...
write_poscar('POSCAR_out',rutile)
