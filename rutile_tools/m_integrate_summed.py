...
class c_integrate_summed:

    # ----------------------------------------------------------------------------------------------

    def __init__(self,file_name,uvw=None,which=None):
        """
    ...
    def _read_data_from_hdf5_file(self,Q,delta):
        ...
        with h5py.File(self.file_name,'r') as db:
            ...
            signal = db['summed_signal'][Qx_inds,...]
        ...
        self.error = np.zeros(self.shape,dtype=float)
    ...
    def plot_volume(self,Q_bin_center,u_binning,v_binning,w_binning,Q_plot_center=None,scale=1e5):
        """
